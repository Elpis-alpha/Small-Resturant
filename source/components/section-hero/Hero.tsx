	...
	return (
		<div className="flex flex-col md:flex-row">
			<div className="flex flex-col gap-4 w-[100%] md:w-[60%] pt-4 md:py-8 z-20 justify-center outfade-hero">
				...
				<Link onClick={scrollHandler} href="/#section-book" className="inline-flex mt-4 self-start items-center md:px-[20px] md:py-[12px] px-[14px] py-[8px] rounded-full text-white bg-brightGreen">
					<span>Book Now</span>
				</Link>
			</div>
